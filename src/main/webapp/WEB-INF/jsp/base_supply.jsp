...
<%
    ...
    String basePath = request.getScheme() + "://"
            ...
            + path + "/";
    List<Supply> list=(List<Supply>)request.getAttribute("supplyList");
%>
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="col-sm-2 pull-right" style="padding-right:0;">
                        <a class="btn btn-primary btn-sm btn-block" href="<%=basePath%>base/supply/add"><i class="fa fa-edit"></i> 新增供应商</a>
                    </div>
                </div>
                ...
                <div class="ibox-content">
                    <div class="clients-list">
                        <ul class="nav nav-tabs">
                            <span class="pull-right small text-muted"><%=list.size()%> 家供应商</span>
                            <li class="active"><a data-toggle="tab" href="#tab-1"><i class="fa fa-user"></i> 供应商信息列表</a></li>
                        </ul>
                                ...
                                <div class="full-height-scroll">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-hover">
                                            ...
                                            <tr>
                                                <td></td>
                                                <td><a   class="client-link"><%=s.getSupplyName()%></a></td>
                                                <td><strong><a  href="<%=basePath%>base/supply/<%=s.getSupplyId().intValue()%>/update" class="client-link">修改</a>
                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    <a  href="<%=basePath%>base/supply/<%=s.getSupplyId().intValue()%>/delete" class="client-link">删除</a>
                                                </strong></td>
                                                <td></td>
