...
</body><%@ page import="com.soecode.lyf.entity.Supply" %>
<%@ page import="java.util.List" %>
<%@ page import="com.soecode.lyf.entity.Product" %>
<%@ page import="com.soecode.lyf.entity.Role" %>
<%@ page import="com.soecode.lyf.entity.Power" %>
<%--
  Created by IntelliJ IDEA.
  User: Administrator
  Date: 2018/4/10
...
<%
    ...
    List<Power> listp=(List<Power>)request.getAttribute("powerList");
%>
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
<!DOCTYPE html>
<html>
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="col-sm-2 pull-right" style="padding-right:0;">
                        <a class="btn btn-primary btn-sm btn-block" href="<%=basePath%>base/role/add"><i class="fa fa-edit"></i> 新增角色</a>
                    </div>
                </div>
                ...
                <div class="ibox-content">
                    <div class="clients-list">
                        <ul class="nav nav-tabs">
                            <span class="pull-right small text-muted"><%=list.size()%> 个角色</span>
                            <li class="active"><a data-toggle="tab" href="#tab-1"><i class="fa fa-user"></i> 角色信息列表</a></li>
                            <li ><a data-toggle="tab" href="#tab-2"><i class="fa fa-user"></i> 权限信息列表</a></li>
                        </ul>
                        <div class="tab-content">
                                ...
                                <div class="full-height-scroll">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-hover">
                                            ...
                                            <tr>
                                                <td></td>
                                                <td><a   class="client-link"><%=s.getRoleName()%></a></td>
                                                <td><strong><a  href="<%=basePath%>base/role/<%=s.getRoleId().intValue()%>/update" class="client-link">修改</a>
                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    <a  href="<%=basePath%>base/role/<%=s.getRoleId().intValue()%>/delete" class="client-link">删除</a>
                                                </strong></td>
                                                <td></td>
                            ...
                            <div id="tab-2" class="tab-pane" style="height: 528px;">
                                <div class="full-height-scroll">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-hover">
                                            <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td></td>
                                                <td><a   class="client-link"><%=p.getPowerName()%></a></td>
