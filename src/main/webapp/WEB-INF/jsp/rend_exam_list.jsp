                ...
                <div class="ibox-content">
                    <div class="clients-list">
                        <ul class="nav nav-tabs">
                            <span class="pull-right small text-muted">xx 个待审核</span>
                            <li class="active"><a data-toggle="tab" href="#tab-1"><i class="fa fa-user"></i> 待审核借出申请列表</a></li>
                        </ul>
                                ...
                                <div class="full-height-scroll">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-hover">
                                            ...
                                            <tr>
                                                <td></td>
                                                <td><a  href="<%=basePath%>resource/rend_exam_detail" class="client-link">曾玲策</a></td>
                                                <td>2018年4月8日</td>
                                                <td>5天</td>
                                            </tr>
                                            </tbody>
