            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="col-sm-2 pull-right" style="padding-right:0;">
                        <a class="btn btn-primary btn-sm btn-block" href="<%=basePath%>base/user/add"><i class="fa fa-edit"></i> 新增用户</a>
                    </div>
                </div>
                ...
                <div class="ibox-content">
                    <div class="clients-list">
                        <ul class="nav nav-tabs">
                            <span class="pull-right small text-muted"><%=list.size()%> 个用户</span>
                            <li class="active"><a data-toggle="tab" href="#tab-1"><i class="fa fa-user"></i> 用户信息列表</a></li>
                        </ul>
                                ...
                                <div class="full-height-scroll">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-hover">
                                            ...
                                            <tr>
                                                <td></td>
                                                <td><a   class="client-link"><%=s.getUserName()%></a></td>
                                                <td><strong><a  href="<%=basePath%>base/user/<%=s.getUserId().intValue()%>/update" class="client-link">修改</a>
                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    <a  href="<%=basePath%>base/user/<%=s.getUserId().intValue()%>/delete" class="client-link">删除</a>
                                                </strong></td>
                                                <td></td>
