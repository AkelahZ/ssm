...
<%
    ...
    String basePath = request.getScheme() + "://"
            ...
            + path + "/";
    List<Power> list=(List<Power>)request.getAttribute("powerList");
    List<Integer> listl=(List<Integer>)request.getAttribute("selectedpower");
    Role s=(Role)request.getAttribute("role");
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5><%=(s!=null)?"修改角色信息":"新增角色"%></h5>
                </div>
                <div class="ibox-content">
                    <form class="form-horizontal" method="post" action="<%=basePath%>base/role/<%=(s!=null)?"update":"add"%>/commit">
                        <%if(s!=null){%>
                        <div class="form-group">
                            <input name="roleId" type="hidden" value="<%=s.getRoleId().intValue()%>"/>
                            <label class="col-sm-2 control-label">角色名字: </label>
                            <div class="col-sm-4 "><input name="roleName" max="20" type="text" class="form-control " value="<%=s.getRoleName()%>"/></div>
                        </div>
                        ...
                        <div id="resource">
                            ...
                            <div id="supply_resource" class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <select name="projectId" class="chosen-select form-control m-b" tabindex="2">
                                        <option value=""  disabled="disabled">选择权限</option>

                                        <%
                                            for (Power p:list
                                                    ) {

                                        %><option <%=(i.intValue()==p.getPowerId().intValue())?"selected=\"selected\"":""%> value="<%=p.getPowerId().intValue()%>" ><%=p.getPowerName()%></option>
                            ...
                            <div id="supply_resource" class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <select name="projectId" class="chosen-select form-control m-b" tabindex="2">
                                        <option value="" selected="selected" disabled="disabled">选择权限</option>

                                        <%
                                            for (Power p:list
                                                    ) {

                                        %><option value="<%=p.getPowerId().intValue()%>" ><%=p.getPowerName()%></option>
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">角色名字: </label>
                            <div class="col-sm-4 "><input name="roleName" max="20" type="text" placeholder="请输入角色的名字" class="form-control "/></div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-2 col-sm-offset-9">
                                ...
                                <a class="btn btn-white" href="<%=basePath%>base/role/list">取消</a>
                            </div>
                        </div>
