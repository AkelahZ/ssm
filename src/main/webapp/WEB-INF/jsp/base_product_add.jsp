        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5><%=(s!=null)?"修改物资品名信息":"新增物资品名"%></h5>
                </div>
                <div class="ibox-content">
                    <form class="form-horizontal" method="post" action="<%=basePath%>base/product/<%=(s!=null)?"update":"add"%>/commit">
                        <%if(s!=null){%>
                        ...
                        <div id="resource">
                            ...
                            <div id="supply_resource" class="form-group">
                                    ...
                                    <input name="productId" type="hidden" value="<%=s.getProductId().intValue()%>"/>
                                    <label class="col-sm-2 control-label">物资品类名字: </label>
                                    <div class="col-sm-4 "><input name="productName" max="20" type="text" class="form-control " value="<%=s.getProductName()%>"/></div>
                ...
                <div id="resource">
                    ...
                    <div id="supply_resource" class="form-group">
                        <label class="col-sm-2 control-label">物资品类名字: </label>
                        <div class="col-sm-4 "><input name="productName" max="20" type="text" class="form-control " placeholder="请输入物资品名"/></div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-2 col-sm-offset-9">
                                ...
                                <a class="btn btn-white" href="<%=basePath%>base/product/list">取消</a>
                            </div>
                        </div>
